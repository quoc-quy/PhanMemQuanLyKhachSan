...
//         TODO add your handling code here:
	...
	private void loadDataToTable() {
		...
		if (ngayCheckIn != null && ngayCheckOut != null && maNhanVien != null) {
			...
			for (HoaDon hoaDon : danhSachHoaDon) {
				...
				String tenKhachHang = hoaDon.getKhachHang() != null ? hoaDon.getKhachHang().getTenKhachHang()
						: "Không có";
				String tenNhanVien1 = hoaDon.getNhanVienLap() != null ? hoaDon.getNhanVienLap().getTenNhanVien()
						: "Không có";
	...
	private void filterTableData() {
		if (originalModel.getRowCount() == 0) {
			System.out.println("Không có dữ liệu trong originalModel");
			return;
		}
